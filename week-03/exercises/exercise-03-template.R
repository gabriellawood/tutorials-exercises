	...
	#Yes, the files contain the same variables.
	# 2. What does one row currently represent?
	#One row represents the amount of types of fish measured in the lower bay on a certain site during certain year. 
	# 3. Which column names appear to contain more than one variable?
	#The fish columns contain two variables, the species and the a or j on the end.
	...
	#Bind rows combines the two data frames and all the rows into a larger data set.
	...
	#One row represented the year, site, region, and species.
	# 2. What does one row represent after the pivot?
	#Now one row represents the year, site, region, species, and count.
	# 3. Why does species_stage still violate the rules of tidy data?
	#It still contains two variables.
	...
	#One row represents a count of fish species measure during a certain year, region, and site seperated by life stage.
	...
	#More juveniles were observed overall.
